...
| `docs/plan/04-roadmap.md` | 开发路线图，按阶段说明从文档基线到 P0 闭环的推进顺序和退出标准。 | 判断当前进度、规划下一个阶段时。 | 阶段顺序、里程碑状态或 P0/P1 边界变化时。 |
...
| `docs/sdd/tasks.md` | SDD 任务执行计划，定义任务就绪门禁、Agent 分工、阶段顺序和 PR 检查清单。 | 判断任务是否可以开工时。 | 门禁、分工、阶段顺序或 PR 检查要求变化时。 |
